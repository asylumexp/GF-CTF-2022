...
#STATE Functions 
    ...
    def home(self):
        ...
        if self.enemy_in_danger_zone():
            ...
            self.turn_towards(Globals.red_flag.x + 130, Globals.red_flag.y, Globals.FAST)
...
# Helper Function
    ...
    def point(self):
        point_distance = self.point_to_point_distance(Globals.red_flag.x + 130, Globals.red_flag.y, self.x, self.y)
